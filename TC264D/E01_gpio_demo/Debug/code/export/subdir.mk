...
C_SRCS += \
../code/export/led_export.c 

OBJS += \
./code/export/led_export.o 

COMPILED_SRCS += \
./code/export/led_export.src 

C_DEPS += \
./code/export/led_export.d 


# Each subdirectory must supply rules for building sources it contributes
code/export/%.src: ../code/export/%.c code/export/subdir.mk
	@echo 'Building file: $<'
...
code/export/%.o: ./code/export/%.src code/export/subdir.mk
	@echo 'Building file: $<'
